...
use App\Http\Controllers\Caixa\CaixaControllerCancelarQuitacao;
use App\Http\Controllers\Caixa\CaixaControllerFechar;
use App\Http\Controllers\Caixa\CaixaControllerPagamento;
use App\Http\Controllers\Caixa\CaixaControllerQuitacaoVale;
use App\Http\Controllers\Caixa\CaixaControllerQuitarVale;
...
use App\Http\Controllers\Colaborador\ColaboradorControllerNovo;
use App\Http\Controllers\Colaborador\ColaboradorControllerTodos;
use App\Http\Controllers\Colaborador\ColaboradorControllerAtualizar;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('colaboradores', [ColaboradorControllerTodos::class, 'obterTodos'])->name('colaboradores');
    Route::get('colaborador/acessar/{id}', [ColaboradorControllerAcessar::class, 'acessar'])->name('colaborador');
    Route::get('colaborador/novo', [ColaboradorControllerNovo::class, 'novo'])->name('novocolaborador');
    Route::post('colaborador/adicionar', [ColaboradorControllerAdicionar::class, 'adicionar'])->name('adicionarcolaborador');
    ...
    Route::get('caixa/controledecaixa/imprimir', [ControleDeCaixaControllerImprimir::class, 'imprimir'])->name('imprimircontroledecaixa');
    ...
    Route::get('caixa/quitarvale/{id}', [CaixaControllerQuitarVale::class, 'quitar'])->name('quitarvale');
